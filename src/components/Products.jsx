...
import { enhanceProductsWithVariants } from "../utils/productUtils";
  ...
  useEffect(() => {
    const getProducts = async () => {
      ...
      if (componentMounted.current) {
        ...
        const enhancedData = enhanceProductsWithVariants(rawData);
        setData(enhancedData);
        setFilter(enhancedData);
        setLoading(false);
      }
    };
          ...
          <div key={index} className="col-lg-4 col-md-6 col-sm-6 col-12 mb-4">
            <div className="card h-100 shadow-sm">
              ...
              <div className="card-body">
                ...
                <Skeleton height={16} width="100%" count={3} style={{ marginTop: 8 }} />
